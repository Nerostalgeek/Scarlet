                        ...
                        <form onSubmit={this.handleSubmit}>
                            <div className={'form-group' + (submitted && !email ? ' has-error' : '')}>
                                ...
                                <input id="email" name="email" type="email"
                                       className="form-control" value={email} onChange={this.handleChange}/>
                                {submitted && !email &&
...
const mapStateToProps = state => {
    return {hideModal: state.displayModal, displayRegisterForm: state.displayRegisterForm, loggingIn: state.authentication }
};
