...
const RentCar = () => {
  ...
  const inputSelected = (event) => {
    ...
    const nextElementToShow = document.getElementById(`rentForm${nextElementNumber}`);
    ...
    for (let arrayIterator = 0; arrayIterator < dbVehicles.default.length; arrayIterator++) {
      if(dbVehicles.default[arrayIterator][previousFieldName] === previousFieldValue) {
    ...
    for(let selectIterator = 0; selectIterator < selectLength; selectIterator++) {
      selectToPopulate.options[selectIterator] = null;
    }

    for(let pushOptionIterator = 0; pushOptionIterator < nextArr.length; pushOptionIterator++) {
      let newOption = document.createElement('option');

      newOption.appendChild( document.createTextNode(`${nextArr[pushOptionIterator]}`));
          ...
          <div className="rent-car-form">
            <form action="">
              <div  id="rentForm1" className="form-rent-car-item">
                ...
                <select data-field-name="make" data-number="1" onChange={inputSelected} className="rent-car-input rent-select">
            ...
            <div class="form-rent-row">
              <div id="rentForm2" className="form-rent-car-item">
                ...
                <select data-field-name="model" data-number="2" onChange={inputSelected} className="rent-car-input rent-select">
              ...
              <div id="rentForm3" className="form-rent-car-item">
                ...
                <select data-field-name="year" data-number="3" className="rent-car-input rent-select">
                  <option>Sélectionnez le modèle de votre véhicule</option>
                </select>
              </div>
              </div>
              <div class="form-rent-row">
                <div id="rentForm4" className="form-rent-car-item">
                  <h4>Moteur :</h4>
                  <select data-field-name="year" data-number="4"  className="rent-car-input rent-select">
                    <option>Sélectionnez le type de moteur de votre véhicule</option>
              ...
              <div id="rentForm5" className="form-rent-car-item">
                <h4>Transmission</h4>
                <select data-field-name="engine" data-number="5"  className="rent-car-input rent-select">
                  <option>Sélectionnez le type de moteur de votre véhicule</option>
              ...
              <div class="form-rent-row">
                <div id="rentForm6" className="form-rent-car-item">
                  ...
                  <select data-field-name="kilometers" data-number="6"  className="rent-car-input rent-select">
                    <option>Sélectionnez le nombre de kilomètres de votre véhicule</option>
                ...
                <div id="rentForm7" className="form-rent-car-item">
                  ...
                  <input type="text" data-field-name="seats" data-number="7" className="rent-car-input" />
                </div>
              </div>
              <div class="form-rent-row">
                <div id="rentForm8" className="form-rent-car-item">
                  <h4>Année d'enregistrement</h4>
                  <input type="text" data-field-name="kilometers" data-number="8" className="rent-car-input" />
                </div>
                <div id="rentForm9" className="form-rent-car-item">
                  <h4>Pays d'enregistrement</h4>
                  <input type="text" data-field-name="seats" data-number="9" className="rent-car-input" />
                </div>
              </div>
